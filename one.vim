...
let s:p.normal.left    = [ [ s:black, s:green, 'bold' ], [ s:white, s:gray2 ], [ s:black, s:cyan2, 'bold' ] ]
let s:p.normal.middle  = [ [ s:white, s:gray3 ] ]
let s:p.normal.right   = [ [ s:black, s:green, 'bold' ], [ s:black, s:gray1,'bold' ], [ s:black, s:cyan, 'bold' ] ]
let s:p.normal.error   = [ [ s:black, s:red2, 'bold'] ]
let s:p.normal.warning = [ [ s:black, s:yellow,'bold' ] ]
let s:p.normal.ok      = [ [ s:black, s:cyan2, 'bold' ] ]
let s:p.insert.right   = [ [ s:bg, s:blue, 'bold' ], [ s:black, s:gray1, 'bold' ] ]
let s:p.insert.left    = [ [ s:bg, s:blue, 'bold' ], [ s:white, s:gray2 ], [ s:black, s:cyan2, 'bold' ] ]
